...
TRANSLATIONS = {
    'CN': {
        ...
        'sidebar_title': "🌌 观测台",
        'version': "Cosmos-Net V10.1 (Bicameral Mind)",
        ...
        'info': "Cosmos-Net V10.1 融合了 MobileNetV2 (视觉)、拓扑记忆 (皮层) 与 双脑机制 (意识)。",
        'main_title': "Cosmos-Net: 数字生命交互界面 (V10.1)",
    ...
    'EN': {
        ...
        'info': "Cosmos-Net V10.1 fuses MobileNetV2 (Eye), Topological Memory (Brain), and Bicameralism (Mind).",
        'main_title': "Cosmos-Net: Digital Life Interface (V10.1)",
